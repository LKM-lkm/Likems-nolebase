...
var Base = (0, common_js_1.CommonMathJaxTermesFontMixin)(FontData_js_1.SvgFontData);
var MathJaxTermesFont = (function (_super) {
    __extends(MathJaxTermesFont, _super);
    function MathJaxTermesFont(options) {
        var e_1, _a;
        ...
        try {
            for (var _b = __values(Object.keys(_this.variant)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                _this.variant[variant].cacheID = 'GT-' + (CLASS.variantCacheIds[variant] || 'N');
            }
        }
    ...
    MathJaxTermesFont.OPTIONS = __assign(__assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-termes-font/svg/dynamic' });
    ...
    MathJaxTermesFont.dynamicFiles = FontData_js_1.SvgFontData.defineDynamicFiles([
        ['latin', {
                'normal': [
