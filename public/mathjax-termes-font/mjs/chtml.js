...
import { CommonMathJaxTermesFontMixin } from './common.js';
...
const Base = CommonMathJaxTermesFontMixin(ChtmlFontData);
export class MathJaxTermesFont extends Base {
    constructor() {
        super(...arguments);
        this.cssFontPrefix = 'GT';
    }
}
MathJaxTermesFont.NAME = 'MathJaxTermes';
MathJaxTermesFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), { fontURL: '@mathjax/mathjax-termes-font/js/chtml/woff2', dynamicPrefix: '@mathjax/mathjax-termes-font/js/chtml/dynamic' });
...
MathJaxTermesFont.defaultDelimiters = delimiters;
...
MathJaxTermesFont.defaultStyles = Object.assign(Object.assign({}, ChtmlFontData.defaultStyles), { 'mjx-container[jax="CHTML"] > mjx-math.GT-N[breakable] > *': {
...
MathJaxTermesFont.defaultFonts = Object.assign(Object.assign({}, ChtmlFontData.defaultFonts), { '@font-face /* MJX-GT-ZERO */': {
...
MathJaxTermesFont.dynamicFiles = ChtmlFontData.defineDynamicFiles([
    ['latin', {
            'normal': [
