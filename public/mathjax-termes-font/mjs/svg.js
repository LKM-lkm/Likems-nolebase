...
const Base = CommonMathJaxTermesFontMixin(SvgFontData);
export class MathJaxTermesFont extends Base {
    constructor(options = {}) {
        super(options);
        const CLASS = this.constructor;
        for (const variant of Object.keys(this.variant)) {
            this.variant[variant].cacheID = 'GT-' + (CLASS.variantCacheIds[variant] || 'N');
        }
    }
}
MathJaxTermesFont.NAME = 'MathJaxTermes';
MathJaxTermesFont.OPTIONS = Object.assign(Object.assign({}, Base.OPTIONS), { dynamicPrefix: '@mathjax/mathjax-termes-font/svg/dynamic' });
...
MathJaxTermesFont.dynamicFiles = SvgFontData.defineDynamicFiles([
    ['latin', {
            'normal': [
    ...
    ['symbols-b-i', {
            ...
            'italic': [
                [0xA1, 0xA7], [0xA9, 0xAE], 0xB1, [0xB5, 0xB7], [0xBA, 0xBF], 0xD7, 0xF0, 0xF7, 0xE3F, [0xFB00, 0xFB04], 0x2020, 0x2021, 0x2030, 0x2031, 0x203D, 0x203F, 0x2040, 0x2052, 0x2054, 0x20A1, 0x20A6, 0x20A9, 0x20AB, 0x20B1, 0x2103, 0x2116, 0x2117, 0x211E, 0x2120, 0x2122, 0x212E, 0x2422, 0x2423
            ],
            'bold-italic': [
                [0xA1, 0xA7], [0xA9, 0xAE], 0xB1, [0xB5, 0xB7], [0xBA, 0xBF], 0xD7, 0xF0, 0xF7, 0xE3F, [0xFB00, 0xFB04], 0x2020, 0x2021, 0x2030, 0x2031, 0x203D, 0x203F, 0x2040, 0x2052, 0x2054, 0x20A1, 0x20A6, 0x20A9, 0x20AB, 0x20B1, 0x2103, 0x2116, 0x2117, 0x211E, 0x2120, 0x2122, 0x212E, 0x2422, 0x2423
            ]
    ...
    ['shapes', {
            'normal': [
                0x2713, 0x2720, 0x27A1, 0x2B1A, 0x2500, 0x2502, 0x250C, 0x2510, 0x2514, 0x2518, 0x251C, 0x2524, 0x252C, 0x2534, 0x253C, 0x2581, 0x2588, [0x2591, 0x2593], 0x25AC, 0x25AD, [0x2660, 0x2667], 0x266A, [0x266D, 0x266F], 0x26AD, 0x26AE
            ],
            'bold': [
    ...
    ['stretchy', {
            ...
            '-lf-tp': [
                0x2A0C, [0x222B, 0x222D]
            ],
            '-rt-bt': [
                0x2A0C, [0x222B, 0x222D]
            ],
            '-ex-md': [
                0x2A0C, 0x222C, 0x222D
            ]
...
MathJaxTermesFont.variantCacheIds = {
    'normal': 'N',
    'bold': 'B',
    'italic': 'I',
    'bold-italic': 'BI',
